...
bool PatternDatabase::setNumMoves(const AbstractRubiksCube &cube, const uint8_t numMoves) {
...
uint8_t PatternDatabase::getNumMoves(const AbstractRubiksCube &cube) const {
