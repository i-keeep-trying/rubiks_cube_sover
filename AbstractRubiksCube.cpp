...
char AbstractRubiksCube::getColorLetter(COLOR color) {
    switch (color) {
        case COLOR::BLUE:
            return 'B';
        case COLOR::GREEN:
...
string AbstractRubiksCube::getMove(MOVE m) {
    switch (m) {
        case MOVE::L:
            return "L";
        case MOVE::LPRIME:
...
AbstractRubiksCube &AbstractRubiksCube::move(MOVE m) {
    switch (m) {
        case MOVE::L:
            return this->l();
        case MOVE::LPRIME:
...
AbstractRubiksCube &AbstractRubiksCube::invert(MOVE m) {
    switch (m) {
        case MOVE::L:
            return this->lPrime();
        case MOVE::LPRIME:
...
void AbstractRubiksCube::print() const {
    cout << "Rubik's Cube:\n\n";
...
vector<AbstractRubiksCube::MOVE> AbstractRubiksCube::randomShuffle(unsigned int times) {
...
string AbstractRubiksCube::getCornerColorString(uint8_t ind) const {
    string str = "";
...
uint8_t AbstractRubiksCube::getCornerIndex(uint8_t ind) const {
...
uint8_t AbstractRubiksCube::getCornerOrientation(uint8_t ind) const {
    string corner = getCornerColorString(ind);
